...
- исходники проекта (репозиторий)
- этот `README.md` с инструкцией запуска
- демонстрация в Swagger: добавить приложение → подождать сбор → запросить availability/outages
